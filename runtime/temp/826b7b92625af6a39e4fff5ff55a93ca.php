<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpStudy\WWW\TpShop\public/../application/admin\view\link\list.html";i:1589012664;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\head.html";i:1588206545;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\left.html";i:1589015760;}*/ ?>
<!DOCTYPE html>
<html>
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <?php if($v['logo']!=""): ?>
                                                            <img src="/tpshop/public/static/uploads/<?php echo $v['logo']; ?>" alt="" height='35'>
                                                            <?php endif; ?>
                                                        </td>
                                                        ...
                                                        <td align="center">
                                                            <a href="<?php echo url('edit',array('id'=>$v['id'])); ?>"
                                                                class="btn btn-primary btn-sm shiny">
                                                                <i class="fa fa-edit"></i> 编辑
                                                            </a>
                                                            <a href="#"
                                                                onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$v['id'])); ?>')"
