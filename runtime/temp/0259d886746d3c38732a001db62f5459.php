<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\phpStudy\WWW\TpShop\public/../application/admin\view\link\add.html";i:1589008485;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\head.html";i:1588206545;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\left.html";i:1589015760;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\foot.html";i:1588206545;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="page-body">
                        <form role="form" class='form-horizontal' action="" method='POST' enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="radio">
                                        ...
                                        <label>
                                            <input name="type" type="radio" class="colored-blue" value='0'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="file" class="" id="logo" placeholder="" name='logo'>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="radio">
                                        <label>
                                            <input name="status" type="radio" class="colored-blue" value="1" checked>
                                            <span class="text">显示</span>
                                        </label>
                                        <label>
                                            <input name="status" type="radio" class="colored-blue" value='0'>
