<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpStudy\WWW\TpShop\public/../application/admin\view\article\picmg.html";i:1588558539;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\head.html";i:1588206545;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\left.html";i:1588559509;}*/ ?>
<!DOCTYPE html>
<html>
                                        ...
                                        <div class="flip-scroll">
                                            <form action="" method='post'>
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php if(is_array($imgs) || $imgs instanceof \think\Collection || $imgs instanceof \think\Paginator): if( count($imgs)==0 ) : echo "" ;else: foreach($imgs as $k=>$v): ?>
                                                        <tr>
                                                            <td class='text-center'><?php echo $k; ?></td>
                                                            <td class='text-center'><?php echo $v; ?></td>
                                                            <td class='text-center'>
                                                                <img src="<?php echo str_replace('D:/phpStudy/WWW','',$v); ?>"
                                                                    alt="" height='25'>
                                                            </td>
                                                            <td class='text-center'>
                                                                <a class="btn btn-danger btn-sm shiny"
                                                                    onclick="warning('确实要删除吗', 'delimg.html?f=<?php echo $v; ?>')"
                                                                    href="#">
