<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\phpStudy\WWW\TpShop\public/../application/admin\view\article\edit.html";i:1588237139;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\head.html";i:1588206545;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\left.html";i:1588234364;s:62:"D:\phpStudy\WWW\TpShop\application\admin\view\common\foot.html";i:1588206545;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="page-body">
                    <form role="form" class='form-horizontal' action="<?php echo url('edit'); ?>" method='POST'
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="cate_id" id="cate_id">
                                    ...
                                    <option value="<?php echo $v['id']; ?>" <?php if($v['id']=$art['cate_id']): ?>selected<?php endif; ?>><?php echo str_repeat('-',$v['level']*3)?><?php echo $v['cate_name']; ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="title" name='title' placeholder="" value="<?php echo $art['title']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="radio">
                                    <label>
                                        <input name="show_top" type="radio" class="colored-blue" value="1" <?php if($art['show_top']==1): ?>checked<?php endif; ?>>
                                        <span class="text">是</span>
                                    </label>
                                    <label>
                                        <input name="show_top" type="radio" class="colored-blue" value='0' <?php if($art['show_top']==0): ?>否<?php endif; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="keywords" id="keywords" cols="30" rows="3"
                                    style='width: 100%;resize:none;'><?php echo $art['keywords']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="description" id="description" cols="30" rows="3" class="form-control"
                                    style='resize:none;'><?php echo $art['description']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="definpu" class='col-sm-2 control-label'>作者</label>
                            <div class="col-sm-8">
                                <input type="text" name="author" id="author" class='form-control' value='<?php echo $art['author']; ?>'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="definpu" class='col-sm-2 control-label'>邮箱</label>
                            <div class="col-sm-8">
                                <input type="text" name="email" id="email" class='form-control' value='<?php echo $art['email']; ?>'>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="definpu" class='col-sm-2 control-label'>外链</label>
                            <div class="col-sm-8">
                                <input type="text" name="link_url" id="link_url" class='form-control' value='<?php echo $art['link_url']; ?>'>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <?php if($art['thumb']!=""): ?>
                                    <img src="/tpshop/public/static/uploads/<?php echo $art['thumb']; ?>" alt="" height='35'>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="content" id="content" ><?php echo $art['content']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
